...
Tested with Llama and T5. The dictionary is written to the standard output. This dictionary is always needed by 
Pasero, even with `--tokenizer hf`.
...
if __name__ == '__main__':
    ...
    vocab = sorted(tokenizer.vocab, key=tokenizer.vocab.__getitem__)
    ...
    while len(vocab) < vocab_size:
        vocab.append(f'madeupword{i:05}')
        i += 1
